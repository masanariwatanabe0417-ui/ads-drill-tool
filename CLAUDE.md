...
<!-- STATE_START -->
- ブランチ: main / コミット: a12ce73 / 状態: ✅ クリーン
- 最終作業: fix: 質問ペインをどの画面でも使えるように（有効条件と文脈受け渡しの根治）
- 次候補: ★最新(2026-07-07d)【質問ペインをどの画面でも使えるように修正（ユーザー指摘）】(main): 症状=単語帳…（詳細・残り候補は NEXT_TASKS.md）
<!-- STATE_END -->
